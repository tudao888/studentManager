...
import com.studentmanager.domain.Company;
import com.studentmanager.domain.enumeration.Line;
import com.studentmanager.repository.CompanyRepository;
...
class CompanyResourceIT {
    ...
    public static Company createEntity(EntityManager em) {
        Company company = new Company().name(DEFAULT_NAME).line(DEFAULT_LINE);
        return company;
    }
    ...
    public static Company createUpdatedEntity(EntityManager em) {
        Company company = new Company().name(UPDATED_NAME).line(UPDATED_LINE);
        return company;
    }
    ...
    void createCompany() throws Exception {
        ...
        assertThat(testCompany.getLine()).isEqualTo(DEFAULT_LINE);
    }
    ...
    void putExistingCompany() throws Exception {
        ...
        updatedCompany.name(UPDATED_NAME).line(UPDATED_LINE);
        ...
        assertThat(testCompany.getLine()).isEqualTo(UPDATED_LINE);
    }
    ...
    void partialUpdateCompanyWithPatch() throws Exception {
        ...
        partialUpdatedCompany.line(UPDATED_LINE);
    ...
    void fullUpdateCompanyWithPatch() throws Exception {
        ...
        partialUpdatedCompany.name(UPDATED_NAME).line(UPDATED_LINE);
