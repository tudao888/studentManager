...
import com.studentmanager.repository.BlogRepository;
...
class BlogResourceIT {
    ...
    public static Blog createEntity(EntityManager em) {
        Blog blog = new Blog().title(DEFAULT_TITLE).description(DEFAULT_DESCRIPTION);
        return blog;
    }
    ...
    public static Blog createUpdatedEntity(EntityManager em) {
        Blog blog = new Blog().title(UPDATED_TITLE).description(UPDATED_DESCRIPTION);
        return blog;
    }
    ...
    void putExistingBlog() throws Exception {
        ...
        updatedBlog.title(UPDATED_TITLE).description(UPDATED_DESCRIPTION);
    ...
    void fullUpdateBlogWithPatch() throws Exception {
        ...
        partialUpdatedBlog.title(UPDATED_TITLE).description(UPDATED_DESCRIPTION);
